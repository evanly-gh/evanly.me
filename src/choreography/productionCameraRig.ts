...
export const PRODUCTION_CAMERA_KEYS: readonly ProductionCamKey[] =
  Object.freeze([
    ...
    key('about-rise', 'about', 0.166, [-60, 10, 80], [-60, 28, -74], 54, 'smooth'),
    key('about-lock-in', 'about', 0.184, [-60, 9, 74], [-60, 27, -74], 54, 'hold'),
    key('about-hold-center', 'about', 0.202, [-60, 9, 74], [-60, 27, -74], 54, 'hold'),
    key('about-hold-exit', 'about', 0.216, [-60, 9, 76], [-60, 26, -74], 52, 'smooth'),
